...
/* Created on:     24/02/2016 22:26:56                          */
/*==============================================================*/
...
/* Index: PARTIDA_FK                                            */
/*==============================================================*/
create  index PARTIDA_FK on PARTIDA (
ID_DET_EGRESO
);
...
alter table PARTIDA
   add constraint FK_PARTIDA_EGRESO_PA_DETALLE_ foreign key (ID_DET_EGRESO)
      references DETALLE_EGRESO (ID_DET_EGRESO)
      on delete restrict on update restrict;
